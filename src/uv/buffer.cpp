...
namespace uv {
    ...
    lua::multiret buffer_base::leq(lua::state& l) const{
        if (l.isstring(2)) {
            size_t len = 0;
            ...
            auto b = lua::stack<buffer_base_ptr>::get(l,2);
            if (b) {
    ...
    lua::multiret buffer_base::hex_decode(lua::state& l) {
    ...
    lua::multiret buffer_base::hex_encode(lua::state& l) {
    ...
    lua::multiret buffer_base::base64_encode(lua::state& l) {
        size_t osize = 0;
        const unsigned char* src = nullptr;
        size_t src_size = 0;
        if (l.isstring(1)) {
    ...
    lua::multiret buffer_base::base64_decode(lua::state& l) {
        size_t osize = 0;
        const unsigned char* src = nullptr;
        size_t src_size = 0;
        if (l.isstring(1)) {
