...
function TestBindings:test_array_ref()
    local b = bind_tests.test_bind_fields.new()
    b.array1[1] = 1
    b.array1[2] = 2
    b.array1[3] = 3
...
function TestBindings:test_array_ref_ref()
    collectgarbage()
    lu.assertEquals(bind_tests.test_bind_fields.get_count(), 0)
    local b = bind_tests.test_bind_fields.new()
    lu.assertEquals(bind_tests.test_bind_fields.get_count(), 1)
...
function TestBindings:test_field_ref()
    local b = bind_tests.test_bind_fields.new()
    b.field4.x = 1
...
function TestBindings:test_field_ref_const()
    local b = bind_tests.test_bind_fields.new()
    b.field4.x = 1
    lu.assertEquals(b.field4.x, 1)
    lu.assertEquals(b.field4.y, 0)
    ...
    lu.assertErrorMsgContains(
        "invalid self object tests::test_bind_struct is const",
        function() 
            f.x = 2
        end
    )
...
function TestBindings:test_field_ref_array()
    local b = bind_tests.test_bind_fields.new()
    b.array2[1].x = 1
    b.array2[2].y = 2
...
function TestBindings:test_field_ref_array_const()
    local b = bind_tests.test_bind_fields.new()
    b.array2[1].x = 1
    b.array2[2].y = 2
    lu.assertEquals(b.array2[1].x, 1)
...
function TestBindings:test_array_bounds()
    local b = bind_tests.test_bind_fields.new()
    lu.assertErrorMsgContains(
        "index out of bounds",
        function() 
...
function TestBindings:test_array_iterator()
    local b = bind_tests.test_bind_fields.new()
    for i=1,5 do
        b.array1[i] = i*2
        b.array2[i].x = i*3
