...
local bind_tests = require 'extern_autobind_tests'

TestExternAutoBindings = {}


function TestExternAutoBindings:test_bindings()
...
function TestExternAutoBindings:test_get_const()
    local b = bind_tests.test_bind_fields.new()
    b.field1 = 1
    local c = b:get_const()
    lu.assertEquals(c.field1, 1)
    lu.assertErrorMsgEquals(
        "invalid self object extern_autobind_tests::test_bind_fields is const",
        function()
            c.field2 = 2.0
        end
    )
    ...
    lu.assertErrorMsgContains(
        "set read only field const_field at extern_autobind_tests::test_bind_fields",
        function()
            b.const_field = 6
        end
    )
...
function TestExternAutoBindings:test_return_ref()
    do
        collectgarbage()
    ...
    do
        ...
        lu.assertErrorMsgContains(
            "invalid self object extern_autobind_tests::test_bind_struct is const",
            function()
                f.x = 300
            end
        )
...
function TestExternAutoBindings:test_optional_ref()
    local b = bind_tests.test_bind_fields.new()
...
function TestExternAutoBindings:test_array_ref()
    local b = bind_tests.test_bind_fields.new()
    b.array1[1] = 1
    b.array1[2] = 2
    b.array1[3] = 3
...
function TestExternAutoBindings:test_array_ref_ref()
    collectgarbage()
    lu.assertEquals(bind_tests.test_bind_fields.get_count(), 0)
    local b = bind_tests.test_bind_fields.new()
    lu.assertEquals(bind_tests.test_bind_fields.get_count(), 1)
...
function TestExternAutoBindings:test_field_ref()
    local b = bind_tests.test_bind_fields.new()
    b.field4.x = 1
...
function TestExternAutoBindings:test_field_ref_const()
    local b = bind_tests.test_bind_fields.new()
    b.field4.x = 1
    lu.assertEquals(b.field4.x, 1)
    lu.assertEquals(b.field4.y, 0)
    ...
    b.field4 = f
    lu.assertErrorMsgContains(
        "invalid reference: need extern_autobind_tests::test_bind_struct, got table",
        function()
            b.field4 = {}
        end
    )
...
function TestExternAutoBindings:test_field_ref_array()
    local b = bind_tests.test_bind_fields.new()
    b.array2[1].x = 1
    b.array2[2].y = 2
...
function TestExternAutoBindings:test_field_ref_array_const()
    local b = bind_tests.test_bind_fields.new()
    b.array2[1].x = 1
    b.array2[2].y = 2
    lu.assertEquals(b.array2[1].x, 1)
    ...
    lu.assertErrorMsgContains(
        "invalid reference: need extern_autobind_tests::test_bind_struct, got nil",
        function()
            b.array2[1] = nil
        end
    )
...
function TestExternAutoBindings:test_array_bounds()
    local b = bind_tests.test_bind_fields.new()
    lu.assertErrorMsgContains(
        "index out of bounds",
        function()
...
function TestExternAutoBindings:test_array_iterator()
    local b = bind_tests.test_bind_fields.new()
    for i=1,5 do
        b.array1[i] = i * 2
        b.array2[i].x = i * 3
...
function TestExternAutoBindings:test_string_field()
    local b = bind_tests.test_bind_fields.new()
...
function TestExternAutoBindings:test_value()
